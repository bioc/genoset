...
head( assayDataElement(rle.ds,"cn.segments") )
@ 
...
database storage, or for looking at fractions of the genome with certain properties.  Rle 
...
DataFrame of Rle, like that returned by \Rfunction{runCBS}.
...
\section{Big Data and bigmemoryExtras}
