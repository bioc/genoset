...
test_RleViews_viewMeans <- function(){
    ...
    two2 = .Call2("RleViews_viewMeans2", s, w, as.numeric(runValue(rle2)), runLength(rle2), TRUE, PACKAGE = "genoset")
    checkEquals(one2,two2, checkNames=FALSE)
    
    one3 = .Call2("RleViews_viewMeans", myview2, FALSE, PACKAGE = "IRanges")
    two3 = .Call2("RleViews_viewMeans2", s, w, as.numeric(runValue(rle2)), runLength(rle2), FALSE, PACKAGE = "genoset")
